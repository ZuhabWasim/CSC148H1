...
class MinimaxUnitTests(unittest.TestCase):
    ...
    def test_stonehenge_one_step(self):
        ...
        for value in new_results:
            ...
            # print('recurs', move_chosen)
            # print('iterative', new_move)
    ...
    def test_stonrhenge_five_steps(self):
        ...
        for move_to_make in newer_results:
            ...
            import copy
            copy = copy.deepcopy(game)
            move_chosen = minimax_recursive_strategy(copy)
            new_move = minimax_iterative_strategy(copy)
            # self.assertEqual(game, copy)
            print()
            print('expected', expected_move)
            print('recursiv', move_chosen)
            print('iterativ', new_move)
            self.assertEqual(move_chosen, new_move)
            self.assertEqual(move_chosen, expected_move)
