...
from assignments.fred.strategy import random_strategy, interactive_strategy
...
class GameInterface:
    ...
    """
    game: Game
    p1_strategy: Callable[[Game], Any]
    p2_strategy: Callable[[Game], Any]

    def __init__(self, game: Any, p1_strategy: Callable,
                 p2_strategy: Callable[[Game], Any]) -> None:
        """
        ...
        self.game = game(is_p1_turn)  # game is any game at the boolean turn.
