...
def preorder_visit(b: Union[BTNode, None], visit: Callable[[BTNode], Any]) -> None:
    """
...
def postorder_visit(b: Union[BTNode, None], visit: Callable[[BTNode], Any]) -> None:
    """
...
def inorder_visit(b: Union[BTNode, None], visit: Callable[[BTNode], Any]) -> None:
    """
...
def levelorder_visit(b: Union[BTNode, None], visit: Callable[[BTNode], Any]) -> None:
    """
