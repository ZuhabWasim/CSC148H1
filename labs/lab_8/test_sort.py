...
if __name__ == "__main__":
    ...
    for algo_ in [selection_sort, insertion_sort_1, insertion_sort_2,
                  ...
                  quicksort_1, quicksort_2, built_in_sort, radixSort]:
        for i in range(1, 7):
            L = generate_data(i * 400)  # Random
            # L = generate_data(i * 400, True)  # Sorted
            # L = generate_data(i * 400, True, True)  # Reverse Sorted
